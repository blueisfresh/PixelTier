...
btnConfirmSelection.addEventListener("click", function () {
  ...
  console.log(
    `Mosaik-Konfiguration: width=${mosaicConfig.width}, height=${mosaicConfig.height}, material=${mosaicConfig.material}, gap=${mosaicConfig.gap}, tileSize=height=${mosaicConfig.tileSize}`
  );
});
